...
cp $PANOO_ROOT/etc/id_central $PANOO_ROOT/ca/private/central.key.pem
openssl req -config server.cnf -key $PANOO_ROOT/etc/id_central -new -out ${TARGET}/${HOSTNAME}.req.pem
